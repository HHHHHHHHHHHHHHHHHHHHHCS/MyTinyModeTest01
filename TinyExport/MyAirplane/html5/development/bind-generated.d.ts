...
declare namespace game{
    class Border extends ut.Component {
        constructor();
        minX: number;
        maxX: number;
        minY: number;
        ...
        static _size: number;
        static _fromPtr(p: number, v?: Border): Border;
        static _toPtr(p: number, v: Border): void;
        static _tempHeapPtr(v: Border): number;
        static _dtorFn(v: Border): void;
    }
    class ChangeOverTime extends ut.Component {
        constructor();
        changPerSecond: number;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
    ...
    class EnemeyTag extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: EnemeyTag): EnemeyTag;
        static _toPtr(p: number, v: EnemeyTag): void;
