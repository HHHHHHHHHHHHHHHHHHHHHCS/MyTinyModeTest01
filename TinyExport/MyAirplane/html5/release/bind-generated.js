...
Object.defineProperties(entities.game.EffectGroup.Component, { cid: { configurable: true, get: function() { delete entities.game.EffectGroup.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.EffectGroup.Component.cid = Module._ut_component_register_cid(/*entities.game.EffectGroup.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::EffectGroup::Component"*/, 0, 0); } } });
...
Object.defineProperties(game.Border, { cid: { configurable: true, get: function() { delete game.Border.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Border.cid = Module._ut_component_register_cid(/*game.Border*/ 16, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Border"*/, 0, 0); } } });
...
Object.defineProperties(game.EnemeyTag, { cid: { configurable: true, get: function() { delete game.EnemeyTag.cid; var offsetsPtr = 0, offsetsCount = 0; return game.EnemeyTag.cid = Module._ut_component_register_cid(/*game.EnemeyTag*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::EnemeyTag"*/, 0, 0); } } });
...
Object.defineProperties(game.EnemySpawner, { cid: { configurable: true, get: function() { delete game.EnemySpawner.cid; var offsetsPtr = 0, offsetsCount = 0; return game.EnemySpawner.cid = Module._ut_component_register_cid(/*game.EnemySpawner*/ 20, 4, 0, offsetsPtr, offsetsCount, 0/*"game::EnemySpawner"*/, ut.DestructorFn._cb.token_for(game.EnemySpawner._dtorFn), ut.CopyFn._cb.token_for(game.EnemySpawner._copyFn)); } } });
...
Object.defineProperties(game.ScrollingBg, { cid: { configurable: true, get: function() { delete game.ScrollingBg.cid; var offsetsPtr = 0, offsetsCount = 0; return game.ScrollingBg.cid = Module._ut_component_register_cid(/*game.ScrollingBg*/ 12, 4, 0, offsetsPtr, offsetsCount, 0/*"game::ScrollingBg"*/, 0, 0); } } });
