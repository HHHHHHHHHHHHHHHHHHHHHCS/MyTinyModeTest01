...
game.TextAligment._typeDesc = (function() {
  var enumType = ut.meta.getType('int32');
  return ut.meta.allocType(6, 'game.TextAligment', 4, [
...
entities.game.Boostrap = entities.game.Boostrap || {};
entities.game.Boostrap.Component = function() {
};
entities.game.Boostrap.Component.prototype = Object.create(null);
entities.game.Boostrap.Component.prototype.constructor = entities.game.Boostrap.Component;
Object.defineProperties(entities.game.Boostrap.Component.prototype, {
});
entities.game.Boostrap.Component._size = 1;
entities.game.Boostrap.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Boostrap.Component.prototype);
  return v;
};
entities.game.Boostrap.Component._toPtr = function(ptr, v) {
};
entities.game.Boostrap.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Boostrap.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Boostrap.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Boostrap.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Boostrap.Component.StorageView.prototype = Object.create(null);
entities.game.Boostrap.Component.StorageView.prototype.constructor = entities.game.Boostrap.Component.StorageView;
entities.game.Boostrap.Component._view = entities.game.Boostrap.Component.StorageView;
entities.game.Boostrap.Component.StorageView._isSharedComp = entities.game.Boostrap.Component._isSharedComp = false;
entities.game.Boostrap.Component.StorageView._fromPtr = entities.game.Boostrap.Component._fromPtr;
entities.game.Boostrap.Component.StorageView._toPtr = entities.game.Boostrap.Component._toPtr;
entities.game.Boostrap.Component.StorageView._tempHeapPtr = entities.game.Boostrap.Component._tempHeapPtr;
entities.game.Boostrap.Component.StorageView._size = entities.game.Boostrap.Component._size;
entities.game.Boostrap.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Boostrap.Component.StorageView.prototype, {
});
entities.game.Boostrap.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Boostrap.Component is a POD type, so a JavaScript side copy constructor entities.game.Boostrap.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Boostrap.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Boostrap.Component', 1, []);
})();
Object.defineProperties(entities.game.Boostrap.Component, { cid: { configurable: true, get: function() { delete entities.game.Boostrap.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Boostrap.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Boostrap.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Boostrap.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Boostrap.Component.cid; } } });
...
game.AutoDestory = function(arg0) {
  this._threshold = (+(arg0===undefined ? 0 : arg0));
};
game.AutoDestory.prototype = Object.create(null);
game.AutoDestory.prototype.constructor = game.AutoDestory;
Object.defineProperties(game.AutoDestory.prototype, {
  threshold: {
    get: function() { return this._threshold; },
    set: function(v) { this._threshold = (+(v===undefined ? 0 : v)); },
  },
});
game.AutoDestory._size = 4;
game.AutoDestory._fromPtr = function(ptr, v) {
  v = v || Object.create(game.AutoDestory.prototype);
  v._threshold = HEAPF32[(ptr+0)>>2];
  return v;
};
game.AutoDestory._toPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.threshold;
};
game.AutoDestory._toTempHeapPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.threshold;
};
game.AutoDestory._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(4);
  if (v) game.AutoDestory._toTempHeapPtr(ptr, v);
  return ptr;
};
game.AutoDestory.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.AutoDestory.StorageView.prototype = Object.create(null);
game.AutoDestory.StorageView.prototype.constructor = game.AutoDestory.StorageView;
game.AutoDestory._view = game.AutoDestory.StorageView;
game.AutoDestory.StorageView._isSharedComp = game.AutoDestory._isSharedComp = false;
game.AutoDestory.StorageView._fromPtr = game.AutoDestory._fromPtr;
game.AutoDestory.StorageView._toPtr = game.AutoDestory._toPtr;
game.AutoDestory.StorageView._tempHeapPtr = game.AutoDestory._tempHeapPtr;
game.AutoDestory.StorageView._size = game.AutoDestory._size;
game.AutoDestory.StorageView.prototype.$advance = function() {
  this._ptr += 4;
};
Object.defineProperties(game.AutoDestory.StorageView.prototype, {
  threshold: {
    get: function() { return HEAPF32[(this._ptr+0)>>2]; },
    set: function(v) { HEAPF32[(this._ptr+0)>>2] = v; },
  },
});
game.AutoDestory._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.AutoDestory is a POD type, so a JavaScript side copy constructor game.AutoDestory._copyFn = function copy(src, dst) { ... } does not need to be generated for it
game.AutoDestory._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.AutoDestory', 4, [
    {name: 'threshold', offset: 0, type: ut.meta.getType('float')}
  ]);
})();
Object.defineProperties(game.AutoDestory, { cid: { configurable: true, get: function() { delete game.AutoDestory.cid; var offsetsPtr = 0, offsetsCount = 0; return game.AutoDestory.cid = Module._ut_component_register_cid_with_type(game.AutoDestory._typeDesc, 4, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(game.AutoDestory.StorageView, { cid: { configurable: true, get: function() { return game.AutoDestory.cid; } } });
game.AutoDestory.threshold = { $ofs:0, $t:"float", $c:game.AutoDestory };
...
game.NumberTextRenderer._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.NumberTextRenderer', 36, [
    ...
    {name: 'alignment', offset: 8, type: ut.meta.getType('game.TextAligment')},
...
game.NumberTextRenderer.alignment = { $ofs:8, $t:"game.TextAligment", $c:game.NumberTextRenderer };
...
game.PipeSpawner = function(arg0, arg1, arg2, arg3, arg4, arg5) {
...
game.PipeSpawner.prototype = Object.create(null);
game.PipeSpawner.prototype.constructor = game.PipeSpawner;
Object.defineProperties(game.PipeSpawner.prototype, {
  time: {
...
game.PipeSpawner._size = 24;
game.PipeSpawner._fromPtr = function(ptr, v) {
  v = v || Object.create(game.PipeSpawner.prototype);
...
game.PipeSpawner._toPtr = function(ptr, v) {
...
game.PipeSpawner._toTempHeapPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.time;
  HEAPF32[(ptr+4)>>2] = v.delay;
  HEAP8[ptr+8] = (v.paused)?1:0;
  HEAPF32[(ptr+12)>>2] = v.distance;
...
game.PipeSpawner._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(24);
  if (v) game.PipeSpawner._toTempHeapPtr(ptr, v);
  return ptr;
};
game.PipeSpawner.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.PipeSpawner.StorageView.prototype = Object.create(null);
game.PipeSpawner.StorageView.prototype.constructor = game.PipeSpawner.StorageView;
game.PipeSpawner._view = game.PipeSpawner.StorageView;
game.PipeSpawner.StorageView._isSharedComp = game.PipeSpawner._isSharedComp = false;
game.PipeSpawner.StorageView._fromPtr = game.PipeSpawner._fromPtr;
game.PipeSpawner.StorageView._toPtr = game.PipeSpawner._toPtr;
game.PipeSpawner.StorageView._tempHeapPtr = game.PipeSpawner._tempHeapPtr;
game.PipeSpawner.StorageView._size = game.PipeSpawner._size;
game.PipeSpawner.StorageView.prototype.$advance = function() {
  this._ptr += 24;
};
Object.defineProperties(game.PipeSpawner.StorageView.prototype, {
  time: {
    get: function() { return HEAPF32[(this._ptr+0)>>2]; },
    set: function(v) { HEAPF32[(this._ptr+0)>>2] = v; },
  },
...
game.PipeSpawner._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.PipeSpawner is a POD type, so a JavaScript side copy constructor game.PipeSpawner._copyFn = function copy(src, dst) { ... } does not need to be generated for it
game.PipeSpawner._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.PipeSpawner', 24, [
...
Object.defineProperties(game.PipeSpawner, { cid: { configurable: true, get: function() { delete game.PipeSpawner.cid; var offsetsPtr = 0, offsetsCount = 0; return game.PipeSpawner.cid = Module._ut_component_register_cid_with_type(game.PipeSpawner._typeDesc, 4, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(game.PipeSpawner.StorageView, { cid: { configurable: true, get: function() { return game.PipeSpawner.cid; } } });
game.PipeSpawner.time = { $ofs:0, $t:"float", $c:game.PipeSpawner };
game.PipeSpawner.delay = { $ofs:4, $t:"float", $c:game.PipeSpawner };
game.PipeSpawner.paused = { $ofs:8, $t:"bool", $c:game.PipeSpawner };
game.PipeSpawner.distance = { $ofs:12, $t:"float", $c:game.PipeSpawner };
game.PipeSpawner.minHeight = { $ofs:16, $t:"float", $c:game.PipeSpawner };
game.PipeSpawner.maxHeight = { $ofs:20, $t:"float", $c:game.PipeSpawner };
